...
>
> **현행 코드와의 정합성:** 이 설계안의 “Phase 11” 표기는 작성 당시의 예정 번호다. 현재
> Phase 11~13은 다른 워크플로우에 배정되어 있으므로, 구현 시에는 `src/workflows/registry.py`
>의 사용 중인 phase ID를 확인해 새 번호를 결정해야 한다. 본 문서는 아직 미구현 설계로 유지한다.
